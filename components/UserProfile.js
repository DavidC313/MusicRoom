...
export default function UserProfile({ testUser = null }) {
    ...
    const user = testUser || defaultUser;

    return (
        <div className="min-h-screen bg-gray-900 p-4 sm:p-6" data-testid="user-profile-container">
            <div className="max-w-4xl mx-auto">
                <div className="bg-gray-800 rounded-xl shadow-lg p-6" data-testid="profile-card">
                    <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
                        <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gray-700 flex items-center justify-center" data-testid="user-avatar">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-8">
                        <div className="bg-gray-700 rounded-lg p-4 sm:p-6" data-testid="stats-card">
